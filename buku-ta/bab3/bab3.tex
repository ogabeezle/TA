...
\begin{algorithm}
    ...
    \begin{algorithmic}[1]
        ...
        \State $points \leftarrow$ Array \fakesc{Point}
        ...
        \State $pts \leftarrow$ Array \fakesc{Point}
        \State $i \leftarrow 0$
        \While{\fakesc{True}}
